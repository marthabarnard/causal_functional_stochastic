...
write_rds(fpca_res, 'model_res2/fpca_res_1_4.rds')
...
mod_df1 <- mod_df[vec1,]
write_rds(mod_df1, 'model_run_data2/mod_df1_1_4.rds')
mod_df2 <- mod_df[vec2,]
write_rds(mod_df2, 'model_run_data2/mod_df2_1_4.rds')

design_pts <- seq(-300, 650, length.out = 750)
...
dr_lincde1_fpca  <- get_w3_t2(n.trees = 2000, depth = 2, centering = F, centeringMethod = "linearRegression",
                              design_pts, delta_vec, mod_df1, mod_df2, 'coef1_2', hyper_grid, 2001, '1_1_4')
write_rds(dr_lincde1_fpca, 'model_res2/mods1_1_4.rds')
...
dr_lincde2_fpca  <- get_w3_t2(n.trees = 2000, depth = 2,centering = F, centeringMethod = "linearRegression",
                              design_pts, delta_vec, mod_df2, mod_df1, 'coef1_2', hyper_grid, 4021, '2_1_4')
write_rds(dr_lincde2_fpca, 'model_res2/mods2_1_4.rds')
